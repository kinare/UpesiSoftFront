                        ...
                        <div class="form-group " :class="formDataError.isBusiness.status">
                            ...
                            <div class="col-sm-12 m-b">
                                <label class="radio-inline">
                                    <input type="radio" value="0" name="isBusiness" v-model="formData.isBusiness"> Individual
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="1" name="isBusiness" v-model="formData.isBusiness"> Business
                                </label>
                            </div>
                            <span class="help-block">{{formDataError.isBusiness.message}}</span>
                        </div>

                        <div class="form-group" v-show="formData.isBusiness === '1'" :class="formDataError.customerBusinessName.status">
                            <label class="control-label">Business Name</label>
                            <input type="text" class="form-control" v-model="formData.customerBusinessName">
                            <span class="help-block">{{formDataError.customerBusinessName.message}}</span>
                        </div>
...
<!--                            Physical Address-->
                            <div class="col-md-6">
                                ...
                                <div v-show="false" class="form-group">
                                    ...
                                    <span class="help-block">{{formDataError.customerCountryCode.message}}</span>
                                </div>
                            </div>
                        </div>
